...
extern "C"
{
    ...
    /// @return 0 on success.
    int fs_set_driver_parameters(fs_device_info_t *device_handle, fs_driver_config_t *driver_config);
    ...
    /// @return 0 on success.
    int fs_get_orientation_euler(fs_device_info_t *device_info, fs_vector3_t *orientation_buffer, bool degrees);
